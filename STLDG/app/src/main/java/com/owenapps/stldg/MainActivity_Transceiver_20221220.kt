...
class MainActivity_Transceiver_20221220 : AppCompatActivity() {
    ...
    private var VERSION = "v4.0.2(+transceiver)"
            ...
            if (cutOffTime(calendar)) {
                ...
                try {
                    ...
                    if (bluetoothConnection != null) {
                        ...
                        var transceiverNumber = getTransceiverRandomNumber()
        ...
        try {
            if (connection != null) {
                ...
                text =  "            3D Games\n" +
                            ...
                            "Ref. No:" + generateRefNum(currentDate, storage) + "\n" +
