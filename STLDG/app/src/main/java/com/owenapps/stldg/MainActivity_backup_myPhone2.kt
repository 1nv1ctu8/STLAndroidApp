...
class MainActivity_backup_myPhone2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendBetsButton.setOnClickListener {
            ...
            if (betList.size > 0) {
                ...
                Toast.makeText(this,"No bets to send.",Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun confirm(calendar: Calendar, storage: SharedPreferences) {
        ...
        okButton.setOnClickListener {
            if (1 == 3) {
                ...
                printReceipt(betList, phoneNumber, sales, currentDate)
    ...
    fun printReceipt(betList: ArrayList<UserData>, phoneNumber: String, sales: Int, currentDate: String) : String {
        var text = ""
        try {
            ...
            if (connection == null) {
                ...
                Toast.makeText(this, "Printer Connection null. Pairing again", Toast.LENGTH_SHORT).show()
            ...
            if (connection != null) {
                ...
                text =  "            3D Games\n" +
                            ...
                            "Ref. No:" + generateRefNum(currentDate, phoneNumber, sales, betList.size) + "\n" +
                ...
                Toast.makeText(this, "Printing Success!", Toast.LENGTH_SHORT).show()
            } else {
    ...
    private fun generateRefNum(currentDate: String, phoneNumber: String, betsAmount: Int, betsTotal: Int) : String {
        ...
        return currentDate.substring(8, 10) + currentDate.substring(0, 2) + currentDate.substring(3, 5) +
                ...
                phoneNumber.substring(9) + dgPattern
